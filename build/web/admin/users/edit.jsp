<%-- 
    Document   : edit
    Created on : May 3, 2023, 7:10:36 PM
                                    ...
                                    <div class="card-body">
                                        <form action="EditUserServlet" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" value="${user.email}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter image">

                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Password</label>
                                                <input type="text" name="password" value="${user.password}" class="form-control" id="exampleInputPassword1" placeholder="Description">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Role</label>
                                                <input type="text" name="role" value="${user.role}" class="form-control" id="exampleInputPassword1" placeholder="Price">
                                            </div>
