<%-- 
    Document   : header
    Created on : Apr 14, 2023, 3:05:16 PM
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <c:if test="${sessionScope.user == null}">
                            ...
                            <button class="dropdown-item" type="button"> <a class="" href="ResgisterServlet">Register</a></button>

                        </c:if>
                        <c:if test="${sessionScope.user != null}">
                            <button class="dropdown-item" type="button"> <a class="" href="LogoutServlet">Logout</a></button>
                        </c:if>
    ...
    <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        <div class="col-lg-4">
            <a href="HomeServlet" class="text-decoration-none">
                <span class="h1 text-uppercase text-primary bg-dark px-2">Mr</span>
                <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Trung</span>
            </a>
        </div>
        ...
        <div class="col-lg-4 col-6 text-right">
            ...
            <h5 class="m-0">+84 886 778 246</h5>
        </div>
    </div>
</div>
<!-- Topbar End -->
